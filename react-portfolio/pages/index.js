        ...
        <section className="  min-h-screen">
          <nav className=" py-10 mb-12 flex justify-between">
            ...
            <ul className="flex items-center">
              ...
              <li>
                <a
                  className=" bg-gradient-to-r from-cyan-500 to-teal-500 text-2hite px-4 py-2 rounded-md ml-8"
                  href="#"
                >
                  Resume
                </a>
          ...
          <div className=" text-center p-10">
            ...
            <p className=" text-md py-5 leading-8 text-gray-800 md: text-xl max-w-lg mx-auto dark:text-gray-300">
              ...
              quisquam? Minima ea ad numquam iusto sint. Minima?
            </p>
          </div>
        ...
        <section>
          <div>
            ...
            <p className=" text-md py-5 leading-8 text-gray-800 dark:text-gray-300">
              ...
              asperiores mollitia cumque. Ea exercitationem labore libero
              voluptas neque quibusdam ex iusto vitae accusantium eligendi
              delectus, dicta earum odit id nihil sed vero. Dolore, velit
              voluptatum ex eveniet et quis corrupti tenetur expedita.
            </p>
          </div>
          <div className=" lg:flex gap-10">
            <div className="  text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white">
              ...
              <p className="py-2">
                ...
                Adipisci sequi, pariatur quidem veniam nam temporibus dolorem
                repudiandae ratione? A nemo molestias ex iste dolores autem quas
                hic earum animi culpa?
              </p>
